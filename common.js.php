...
function customers_validateData(){
	...
	if($j('#CustomerID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Customer ID", close: function(){ $j('[name=CustomerID]').focus(); $j('[name=CustomerID]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function order_details_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function shippers_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#CompanyName').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Company Name", close: function(){ $j('[name=CompanyName]').focus(); $j('[name=CompanyName]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
