...
function products_insert(){
	...
	sql("insert ignore into membership_userrecords set tableName='products', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'", $eo);
