...
function employees_insert(){
	...
	sql("insert ignore into membership_userrecords set tableName='employees', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'", $eo);
