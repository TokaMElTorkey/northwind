...
function shippers_insert(){
	...
	sql("insert ignore into membership_userrecords set tableName='shippers', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'", $eo);
