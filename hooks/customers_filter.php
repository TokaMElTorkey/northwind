        ...
        ?>        <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
            ...
            <div id="9_DropDown" class="drop-down col-md-3 col-sm-6 col-xs-10 vspacer-lg"><span></span></div>
            ...
            <input type="hidden" name="FilterValue[1]" id="9_currValue" value="<?php echo htmlspecialchars($FilterValue[1]); ?>" size="3">
        ...
        <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        <div class="col-md-offset-3 col-md-2 col-sm-3 col-xs-12 vspacer-lg"><strong>Company Name</strong></div>
          <button type="button" class="btn btn-default pull-col-lg-3 vspacer-lg" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-trash text-danger"></button>
        ...
        <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        <div class="col-md-offset-3 col-md-2 col-sm-3 col-xs-12 vspacer-lg"><strong>Contact Name</strong></div>
          <button type="button" class="btn btn-default pull-col-lg-3 vspacer-lg" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-trash text-danger"></button>
        ...
        <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        <div class="col-md-offset-3 col-md-2 col-sm-3 col-xs-12 vspacer-lg"><strong>City</strong></div>
          <button type="button" class="btn btn-default pull-col-lg-3 vspacer-lg" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-trash text-danger"></button>
        ...
        <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        <div class="col-md-offset-3 col-md-2 col-sm-3 col-xs-12 vspacer-lg"><strong>Postal Code</strong></div>
          <button type="button" class="btn btn-default pull-col-lg-3 vspacer-lg" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-trash text-danger"></button>
