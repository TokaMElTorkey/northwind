     ...
     <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        ...
        <div class="col-md-offset-2 col-md-2 vspacer-lg"><strong>Category</strong></div>
    ...
    $j(function(){
        ...
        if ($j("#filterfield_4").val().length){
            ...
            $j.ajax({
                url: 'ajax_combo.php',
                dataType: 'json',
                data: { s: $j("#filterfield_4").val(),  //search term
                        p: 1,                                         //page number
                        t:"products",                //table name
                        f:"CategoryID"               //field name
     ...
     <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        ...
        <div class="col-md-offset-2 col-md-2 vspacer-lg"><strong>Supplier</strong></div>
        <button type="button" class="btn btn-default pull-right" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-off"></button>
    ...
    $j(function(){
     ...
     <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        <div class="col-md-offset-2 col-md-2 vspacer-lg"><strong>Product Name</strong></div>
        <button type="button" class="btn btn-default pull-right" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-off"></button>
     ...
     <div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
        ...
        <div class="col-md-offset-2 col-md-2 vspacer-lg"><strong>Unit Price</strong></div>
        <button type="button" class="btn btn-default pull-right" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-off"></button>
    ...
    <div class="row" style="border-bottom: dotted 2px #DDD;">
                ...
                <div class="col-md-offset-2 col-md-2 vspacer-lg"><strong>Discontinued</strong></div>
                <button type="button" class="btn btn-default pull-right" title='Clear fields'  onclick="clearFilters(this);" ><span class="glyphicon glyphicon-off"></button>
                <div class="col-md-8 col-md-offset-3">
                <div class="radio">
                    <label><input type="radio" name="FilterValue[7]" class="filter_10" onclick="checkboxFilter(this)" value="1" > Checked</label>
                </div>
                <div class="radio">
                    <label><input type="radio" name="FilterValue[7]" class="filter_10" onclick="checkboxFilter(this)" value="null"> Unchecked</label>
                </div>
                <div class="radio">
                    <label><input type="radio" name="FilterValue[7]" class="filter_10" onclick="checkboxFilter(this)" value="" checked> Any</label>
               </div>
            </div>

            <input type="hidden" name="FilterAnd[7]" value="and">
            <input type="hidden" name="FilterField[7]" value="10">   
            <input type="hidden" name="FilterOperator[7]" id="filter_10" value="equal-to">
    ...
    <script>
        ...
        //for population
        var filterValue_10 = '<?php echo htmlspecialchars($FilterValue[7]); ?>';
        $j(function () {
            if (filterValue_10) {
                $j("input[class =filter_10][value =" + filterValue_10 + "]").attr("checked", "checked").click();
            }
        })
